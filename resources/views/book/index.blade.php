    ...
    <tbody>
        ...
        <tr>
            <td width="60px" height="60px">
                ...
                <img class="img-thumbnail" width="50px" height="50px" src="{{ Storage::url($photo) }}" alt="">
                @endif

            </td>
            <td>
                <a href="{{ route('books.edit',$book->id) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
